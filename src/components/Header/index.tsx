        ...
        >
          ...
          >
            <motion.a
              ...
              className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-white/10 backdrop-blur-md shadow-lg overflow-hidden transition-all duration-300 hover:w-32 hover:rounded-xl"
              whileHover={{
            ...
            >
              <svg
                className="w-6 h-6 text-white group-hover:mr-2"
                fill="currentColor"
                viewBox="0 0 24 24"
              ...
              <span className="absolute transform scale-0 opacity-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 font-medium ml-6">
                GitHub
              </span>
            </motion.a>
